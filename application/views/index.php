                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-4">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl"><?php echo $row->notice_title?></div>
                            <div class="widget-function am-fr">
                                <div class="widget-title am-fl">社团名称：<?php echo $row->club_name?></div>
                                &nbsp;
                        ...
                        <div class="widget-body am-fr">
                            <div class="am-fl">
                                <div class="widget-fluctuation-period-text" id="notice">
                                    <?php echo $row->notice_con;?>
                                </br></br>

                                    <span>发布时间: <?php echo $row->notice_time?></span>
                                </div>
                            </div>
